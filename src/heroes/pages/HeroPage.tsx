...
export const HeroPage: FC = () => {
  ...
  const onNavigateback = () => {
    ...
    if (hero?.publisher === 'Marvel Comics') {
      //Todo:Arreglar que al dar click vuelva a la pagina correcta
      navigate(`/marvel-Local`, { replace: true });
    }

    if (hero?.publisher === 'DC Comics') {
      //Todo:Arreglar que al dar click vuelva a la pagina correcta
      navigate(`/dc-Local`, { replace: true });
    }
  ...
  if (!hero) {
    return <Navigate to={'/marvel-local'} />;
  }
